export const passwordResetTemplate = (passwordResetLink, name) => {
  return `
    <!doctype html>
<html>
  <head>
						...
						<tr>
							<td 
								...
								style="height: 5px; 
									...
									background-image: linear-gradient(-45deg, #000000, #EB2B33);"
							>
								<img 
									src="https://moiseshp.github.io/email-templates-for-developers/storage/transparent.png" 
									width="1" 
								...
								>
									<tr>
										<td align="center">
											...
											-->
											<img 
												src="https://standardtouch.com/wp-content/uploads/2021/11/ST-Transparent-Logo-Final-2.png" 
												width="170"
										...
										<td>
											<p 
												style="font-family: Arial, Helvetica, sans-serif; 
													...
													line-height: 20px;"
											>
												Yaseen and the <strong style="font-weight: bold; color: #010E28">Standard Touch</strong> Team.
											</p>
										</td>
									</tr>
									<tr>
										...
										<td>
											<p 
												style="font-family: Arial, Helvetica, sans-serif; 
													...
													text-align: center"
											>
												Fermentum varius, <a href="mailto:yaseen@standardtouch.com" style="color: #EB2B33">yaseen@standardtouch.com</a> 
												<br />
												Glass House, Karnataka, India
												<br />
...
export const accountCreationTemplate = (createPasswordLink, name) => {
  return `
    <!doctype html>
    <html>
      <head>
        ...
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <meta name="description" content="Account Creation - Email Templates for developers" />
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>Account Creation - Email Templates for developers</title>
        <style>
          html,
          body {
            margin: 0 auto !important;
                        ...
                        <td>
                          ...
                          <p 
                            style="font-family: Arial, Helvetica, sans-serif; 
                              ...
                              padding: 0"
                          >
                            Welcome to Standard Touch! Your account has been created.
                          </p>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <p 
                            style="font-family: Arial, Helvetica, sans-serif; 
                              ...
                              line-height: 20px;"
                            >
                            Please create your password by clicking the button below:
                          </p>
                        </td>
                      </tr>
                      <tr>
